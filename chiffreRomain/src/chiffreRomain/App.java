...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("Veuillez indiquer un chiffre en 0-999?");
	...
	public static String chiffreRomain(int chiffre, String symbole1, String symbole5, String symbole10){
		String result = "";
		
		switch (chiffre) {
		case 3: result += symbole1;			
		case 2: result += symbole1;			
		case 1: result += symbole1;			
			break;
		case 4: result += symbole1 + symbole5;	
			break;
		case 8: result += symbole1;
		case 7: result += symbole1;
		case 6: result += symbole1;
		case 5 : result = symbole5 + result;
			break;
		case 9 : result += symbole1 + symbole10;
			break;
		}
		return result;
	}
