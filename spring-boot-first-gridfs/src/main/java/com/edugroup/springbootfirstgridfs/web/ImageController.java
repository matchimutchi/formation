package com.edugroup.springbootfirstgridfs.web;
...
import com.edugroup.springbootfirstgridfs.repositories.ImageRepository;
...
public class ImageController {
	...
	public ResponseEntity<InputStreamResource> getFile(@RequestParam("id") String id) throws IllegalStateException, IOException {
		...
		InputStreamResource binaryData = new InputStreamResource(resource.getInputStream());
		...
		headers.set("Content-Disposition", "attachement; filename=" + resource.getFilename());
	...
	public ResponseEntity<InputStreamResource> getFile(@RequestParam("id") int id) throws IllegalStateException, IOException {
		...
		GridFSFile fileInfos=  this.gridFsTemplate.findOne(new Query(Criteria.where("_id").is(
