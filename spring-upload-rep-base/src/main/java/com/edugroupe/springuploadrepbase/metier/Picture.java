package com.edugroupe.springuploadrepbase.metier;
...
public class Picture {
	...
	private String storageid; //cle de stockage
	@JsonIgnore @Column(length = 60)
	private String fileHash; //somme de controle du fichier
	@JsonIgnore @Column(length = 60)
	private String thumbStorageId; //clef de stockage de la miniature
