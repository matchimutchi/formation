				...
				<tbody>
					<c:forEach items="${requestScope.films}" var="film">
						<tr>
							...
							<td style="text-align:center"><a target="_blanck" href="/webjdbcdao/FilmServlet/<c:out value='${film.id}'></c:out>">Editer</a></td>
							<td style="text-align:center"><a target="_blanck" href="/webjdbcdao/FilmServlet/*<c:out value='${film.id}'></c:out>">Supprimer</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
