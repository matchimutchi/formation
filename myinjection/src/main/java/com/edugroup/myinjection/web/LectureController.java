package com.edugroup.myinjection.web;
...
import com.edugroup.myinjection.repositories.JDBCLivreRepositoryInterface;
...
public class LectureController {
	...
	@Autowired
	private JDBCLivreRepositoryInterface jdbcLivreRepository;
	...
	public Map<String, String> updateEmail(@RequestParam("email") String email, @RequestParam("userId") int userId){
