...
<body>
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<nav class="navbar  navbar-dark bg-dark">
					<a class="navbar-brand" href="#">Edition - Création d'une ville</a>
		...
		<!-- DEBUT INJECTION -->
		<div class="row">
			<div class="col-md-10 offset-md-1 text-white shadow p-3 mb-5 bg-dark rounded">
				<form action="/save" method="post">
					...
					<div class="form-group">
						<label for="nom">Nom</label> <input type="text"
							class="form-control" name="nom" id="nom" value="${ville.nom}">
					</div>
					<div class="form-group">
						<label for="population">Population</label>
						<input type="text"
							class="form-control" name="population" id="population" value="${ville.population}">
					</div>
					<div class="form-group">
						<label for="surface">Surface</label> <input type="text"
							class="form-control" name="surface" id="surface" value="${ville.surface}">
					</div>
					<div class="form-group">
						<label for="pays">Pays</label> <input type="text"
							class="form-control" name="pays" id="pays" value="${ville.pays}">
					</div>					
					<br>
					<div class="form-group">
