	...
	public void run() {
		try {
			...
			while(true) {
				...
				System.out.println("Travailleur " + Thread.currentThread().getName() +" récupére" + valeur);
				long resultat = fibonacci(valeur);
				System.out.println("Travailleur " + Thread.currentThread().getName() +" résultat calcul " + resultat);
			
		}
		}catch(RuntimeException ex) {
			System.out.println("file d'attente terminé");
		}
