	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<nav class="navbar  navbar-dark bg-dark">
					<a class="navbar-brand" href="#">Edition - Création d'un realisateur</a>
		...
		<div class="row">
			<div
				...
				<form action="/saveRealisateur" method="post">
					<div class="form-group">
						<input type="hidden" class="form-control" id="id" name="id"
							value="${realisateur.id}">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input class="form-control" name="prenom" id="prenom" value="${realisateur.prenom}">

					</div>
					<div class="form-group">
						<label for="societe">Societe</label> <input type="text"
							class="form-control" name="societe" id="societe"
							value="${realisateur.societe}">
					</div>
									
					<br>
					<div class="form-group">
						<input type="submit" class="btn btn-warning" value="Sauvegarder">
						<a href="http://localhost:8080/accueil" class="btn btn-danger">Retour</a>
			...
			<div class="col-md-4 offset-md-1 ">
				<div class="card text-white shadow p-3 mb-5 bg-dark rounded"
					...
					<div class="card-body">
						...
						<p class="card-text">
							<b>Prenom</b> : ${realisateur.prenom}
						</p>
						<p class="card-text">
							<b>Societe</b> : ${realisateur.societe}
						</p>
					</div>
				</div>
			</div>
