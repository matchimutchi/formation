					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							<li class="nav-item active"><a class="nav-link"
								href="http://localhost:8080/bonjour">Détail des livres</a></li>
				...
				<form action="/save" method="post">
					...
					<div class="form-group">
						<label for="isbn">ISBN</label> <input type="text"
							class="form-control" name="isbn" id="isbn" value="${livre.isbn}">
					</div>
					<div class="form-group">
			...
			<div class="col-md-4 offset-md-1 ">
				<div class="card text-white shadow p-3 mb-5 bg-dark rounded" style="width: 19rem;">
					...
					<div class="card-body">
						...
						<p class="card-text"><b>Nb Pages</b> : ${livre.nbPages}</p>
						<p class="card-text"><b>No ISBN</b> : ${livre.isbn}</p>
						<p class="card-text"><b>Auteur</b>: ${livre.auteur}</p>
					</div>
				</div>
			</div>
		</div>
